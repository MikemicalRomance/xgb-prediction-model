...
# TASK 2.1 load model and make predictions
...
encoded_predictions = predict_function(
...
output_dataframe = binary_decode(
    encoded_predictions, ["Adopted_prediction"], ["Yes"], ["No"]
)
# TASK 2.1 save the outputs to output dir
