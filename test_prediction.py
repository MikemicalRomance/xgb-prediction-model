...
def test_predict_function():
    #call function
    actual_columns= list(predict_function(trained_model=loaded_model,unencoded_data=petfinder_df,encoded_data=fully_encoded_df,target_variable="Adopted",predicted_variable="Adopted_prediction").columns.values)  
    #set expectations
    expected_columns = df_columns = ["Type","Age","Breed1","Gender","Color1","Color2","MaturitySize","FurLength","Vaccinated","Sterilized","Health","Fee","PhotoAmt","Adopted","Adopted_prediction"]
    #assertion
